...
they show can't drift apart -- they read the same total_weight, max_messages, and the
...
def make_context(app, monitors, primary=0):
    ...
    return HudContext(st.total_weight(), r.max_messages, r.max_alpha, len(st.items),
